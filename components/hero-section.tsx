    ...
    <section className="min-h-screen flex items-center justify-center px-4 py-20 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-hero">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-balance mb-6 animate-fade-in-heading">
          ...
          <span className="inline-flex items-center justify-center flex-wrap gap-2 mt-4 sm:mt-6 md:mt-8">
            ...
            <RotatingText
              ...
              mainClassName="px-2 sm:px-2 md:px-3 overflow-hidden py-1 sm:py-1 md:py-2 justify-center rounded-lg"
              style={{ color: "#04C5FF" }}
              staggerFrom={"last"}
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8 sm:mb-16 animate-fade-in-buttons">
          <Button
            size="lg"
            className="rounded-full px-8 py-4 text-lg font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg group cursor-pointer relative overflow-hidden"
          >
            Falar com a gente
            <ArrowRight />
          </Button>
          ...
          <Button
            variant="outline"
            size="lg"
            className="rounded-full px-8 py-4 text-lg font-medium transition-all duration-200 hover:scale-105 group cursor-pointer"
          >
            <Play />
            Ver demo
          </Button>
